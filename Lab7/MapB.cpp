...
int functionHash(const string& s){
	int pos = 0;
...
void MapB::rehashing(vector<pair<string,int>> &v){
...
MapB::MapB(){ v = vector<pair<string,int>>(1000); } // tamaño de la tabla hash

MapB::~MapB(){} // destructor

void MapB::insert(const string &s, int n){
...
void MapB::erase(const string &s){
	int pos = functionHash(s) % v.size();
	while(true){
